...
export const or =
  ...
  input => {
    ...
    return [error('(or) neither parser 1 nor parser 2 satisfied'), input]
  }
export const or2 = or
export const or3 =
  ...
  input => {
    ...
    return [error('(or) none of parsers 1..3 satisfied'), input]
  }
export const or4 =
  ...
  input => {
    ...
    return [error('(or) none of parsers 1..4 satisfied'), input]
  }
export const or5 =
  <A, B, C, D, E>(
    parser1: Parser<A>,
  ...
  input => {
    ...
    return [error('(or) none of parsers 1..5 satisfied'), input]
  }
...
export const and3 = <A, B, C>(parser1: Parser<A>, parser2: Parser<B>, parser3: Parser<C>): Parser<[A, B, C]> =>
  sequence(parser1, result1 => sequence(parser2, result2 => map(parser3, result3 => [result1, result2, result3])))
export const and4 = <A, B, C, D>(
  ...
  sequence(parser1, result1 =>
    sequence(parser2, result2 =>
      sequence(parser3, result3 => map(parser4, result4 => [result1, result2, result3, result4]))
    )
  )
export const and5 = <A, B, C, D, E>(
  ...
  sequence(parser1, result1 =>
    sequence(parser2, result2 =>
      sequence(parser3, result3 =>
        sequence(parser4, result4 => map(parser5, result5 => [result1, result2, result3, result4, result5]))
      )
    )
  )
